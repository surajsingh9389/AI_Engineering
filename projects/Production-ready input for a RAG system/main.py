...
obj1 = ChunkingPipeline(300, 5)
sentences = obj1.build_sentences(text)
chunks = obj1.create_chunks(sentences)
data = obj1.add_metadata(chunks, "Human Discovery", "History")
print(data)
print(obj1.validate_chunk(data[0]))
